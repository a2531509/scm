...
<body>
	...
	$(function(){
		...
		$("#search").click(function(){
			$.ajax({
				url: "${proPath}/accountRecords/selectSupplier.action",
				...
				alert(result);
				  ...
				  var data=new Array();  //data是一个数组
					$(result).each(function(i){
						...
						data[i][0]=this.sup_name; data[i][1]=this.total;
					});
					...
					myChart.setAxisNameX('供应商',true);
					myChart.setAxisNameY('金额',true);
					myChart.setTitle("供应商采购统计报表");
